...
A few months ago I skimmed the first few chapters of `crafting interpreters <https://craftinginterpreters.com/>`_ in order to have a bit of the theoretical background required to build `some solhint rules <https://github.com/protofire/solhint/pull/417>`_, and found out it's a great resource.
...
- Improve my code's **correctness**. Given that I've been working with smart contracts for a long
  ...
  I plan on doing rust's  programmers' manual for this.
